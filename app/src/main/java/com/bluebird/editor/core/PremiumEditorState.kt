package com.bluebird.editor.editor.core
...
import com.bluebird.editor.core.Bookmark
import com.bluebird.editor.core.EditorSettings
import com.bluebird.editor.core.FileEncoding
import com.bluebird.editor.core.FindResult
import com.bluebird.editor.core.HistoryEntry
import com.bluebird.editor.core.LineEnding
import com.bluebird.editor.core.TabData
import com.bluebird.editor.editor.actions.ActionResult
import com.bluebird.editor.editor.actions.computeStats
import com.bluebird.editor.editor.actions.convertLineEndings
import com.bluebird.editor.editor.actions.cutText
import com.bluebird.editor.editor.actions.deleteLine
import com.bluebird.editor.editor.actions.detectLineEnding
import com.bluebird.editor.editor.actions.duplicateLine
import com.bluebird.editor.editor.actions.handleCharInput
import com.bluebird.editor.editor.actions.handleEnter
import com.bluebird.editor.editor.actions.handleTab
import com.bluebird.editor.editor.actions.insertText
import com.bluebird.editor.editor.actions.moveLineDown
import com.bluebird.editor.editor.actions.moveLineUp
import com.bluebird.editor.editor.actions.removeDuplicateLines
import com.bluebird.editor.editor.actions.selectLine
import com.bluebird.editor.editor.actions.selectWord
import com.bluebird.editor.editor.actions.sortLines
import com.bluebird.editor.editor.actions.toCamelCase
import com.bluebird.editor.editor.actions.toLowerCase
import com.bluebird.editor.editor.actions.toSnakeCase
import com.bluebird.editor.editor.actions.toTitleCase
import com.bluebird.editor.editor.actions.toUpperCase
import com.bluebird.editor.editor.actions.toggleLineComment
import com.bluebird.editor.editor.actions.trimTrailingWhitespace
import com.bluebird.editor.editor.highlighting.extractWords
import com.bluebird.editor.editor.highlighting.getSuggestions
import java.io.File
...
class PremiumEditorState(
    ...
    val isDark get() = com.bluebird.editor.ui.theme.EdThemes.get(settings.theme).isDark
    val colors get() = com.bluebird.editor.ui.theme.EdThemes.get(settings.theme)
