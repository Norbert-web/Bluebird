...
import com.win11launcher.AppTheme
    ...
    SettingsGroup("Theme", a) {
        Column(modifier = Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(10.dp)) {
            ...
            val themes = listOf(
                ...
                ThemeOption(AppTheme.SPECIAL, Icons.Default.Star,               "Special ✦","Deep indigo — Claude-inspired",           Color(0xFF12092A), Color(0xFF9C6BF7))
            )
