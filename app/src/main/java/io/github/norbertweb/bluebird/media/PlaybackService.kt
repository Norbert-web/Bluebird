...
class PlaybackService : MediaSessionService() {
    ...
    companion object {
        const val CMD_SET_EQ_PRESET   = "io.github.norbertweb.bluebird.SET_EQ_PRESET"   // args: IntArray "value" (band gains, mB)
        const val CMD_SET_BASS_BOOST  = "io.github.norbertweb.bluebird.SET_BASS_BOOST"  // args: Boolean "value"
        const val CMD_SET_VIRTUALIZER = "io.github.norbertweb.bluebird.SET_VIRTUALIZER" // args: Boolean "value"
        const val CMD_SET_CROSSFADE   = "io.github.norbertweb.bluebird.SET_CROSSFADE"   // args: Int "value" (0-10 sec)
